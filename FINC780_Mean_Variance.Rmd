...
# Polynomial regression for a guaranteed smooth parabolic arc
poly_fit <- lm(retn_optim ~ poly(sig_optim, 3), data = optim_frontier)
...
smooth_curve$retn_optim <- predict(poly_fit, smooth_curve)
